...
try:
    ...
    update_player = ("UPDATE player SET team_id = 2, first_name = 'Russel', last_name = 'Wilson' WHERE first_name = 'Jose'")

    cursor.execute(update_player)

    show_players(cursor, "DISPLAYING PLAYERS AFTER UPDATE")

    delete_player = ("DELETE FROM player WHERE first_name = 'Russel'")
